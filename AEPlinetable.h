 ...
 */
#ifndef _AEPLINETABLE_H_
#define _AEPLINETABLE_H_
#pragma once
...
typedef enum
{
    ...
    LIB3A_AE_SCENE_ISO22                    = 22,
    LIB3A_AE_SCENE_ISO40                    = 40,
    LIB3A_AE_SCENE_ISO50                    = 50,
    LIB3A_AE_SCENE_ISO64                    = 64,
    LIB3A_AE_SCENE_ISO80                    = 80,
    LIB3A_AE_SCENE_ISO100                   = 100,
    LIB3A_AE_SCENE_ISO125                   = 125,
    LIB3A_AE_SCENE_ISO150                   = 150,
    LIB3A_AE_SCENE_ISO160                   = 160,
    LIB3A_AE_SCENE_ISO200                   = 101,
    LIB3A_AE_SCENE_ISO250                   = 250,
    LIB3A_AE_SCENE_ISO300                   = 300,
    LIB3A_AE_SCENE_ISO320                   = 400,
    LIB3A_AE_SCENE_ISO400                   = 102,
    LIB3A_AE_SCENE_ISO500                   = 500,
    LIB3A_AE_SCENE_ISO600                   = 600,
    LIB3A_AE_SCENE_ISO640                   = 640,
    LIB3A_AE_SCENE_ISO800                   = 103,
    LIB3A_AE_SCENE_ISO1000                  = 1000,
    LIB3A_AE_SCENE_ISO1200                  = 1200,
    LIB3A_AE_SCENE_ISO1250                  = 1250,
    LIB3A_AE_SCENE_ISO1600                  = 104,
    LIB3A_AE_SCENE_ISO2000                  = 2000,
    LIB3A_AE_SCENE_ISO2400                  = 2400,
...
typedef enum
{
    ...
    LIB3A_AE_ISO_SPEED_22                   =     22,
    LIB3A_AE_ISO_SPEED_40                   =     40,
    LIB3A_AE_ISO_SPEED_50                   =     50,
    LIB3A_AE_ISO_SPEED_64                   =     64,
    LIB3A_AE_ISO_SPEED_80                   =     80,
    LIB3A_AE_ISO_SPEED_100                  =    100,
    LIB3A_AE_ISO_SPEED_125                  =    125,
    LIB3A_AE_ISO_SPEED_150                  =    150,
    LIB3A_AE_ISO_SPEED_160                  =    160,
    LIB3A_AE_ISO_SPEED_200                  =    200,
    LIB3A_AE_ISO_SPEED_250                  =    250,
    LIB3A_AE_ISO_SPEED_300                  =    300,
    LIB3A_AE_ISO_SPEED_320                  =    320,
    LIB3A_AE_ISO_SPEED_400                  =    400,
    LIB3A_AE_ISO_SPEED_500                  =    500,
    LIB3A_AE_ISO_SPEED_600                  =    600,
    LIB3A_AE_ISO_SPEED_640                  =    640,
    LIB3A_AE_ISO_SPEED_800                  =    800,
    LIB3A_AE_ISO_SPEED_1000                 =   1000,
    LIB3A_AE_ISO_SPEED_1200                 =   1200,
    LIB3A_AE_ISO_SPEED_1250                 =   1250,
    LIB3A_AE_ISO_SPEED_1600                 =   1600,
    LIB3A_AE_ISO_SPEED_2000                 =   2000,
    LIB3A_AE_ISO_SPEED_2400                 =   2400,
    LIB3A_AE_ISO_SPEED_3200                 =   3200,
    LIB3A_AE_ISO_SPEED_6400                 =   6400,
    LIB3A_AE_ISO_SPEED_12800                =   12800,
    LIB3A_AE_ISO_SPEED_MAX = LIB3A_AE_ISO_SPEED_12800,
...
typedef enum
{
    ...
    AETABLE_CAPTURE_ISO300,
    AETABLE_CAPTURE_ISO400,
    AETABLE_CAPTURE_ISO600,
    AETABLE_CAPTURE_ISO800,
    AETABLE_CAPTURE_ISO1200,
    AETABLE_CAPTURE_ISO1600,
    AETABLE_CAPTURE_ISO2400,
...
typedef struct
{
   strEvSetting sPlineTable[2000];   // Finer EV Pline structure table
} strFinerEvPline;
typedef struct
{
    eAETableID   eID;
...
typedef struct
{
    ...
    MUINT32 u4MinGain_x1024;
    MUINT32 u4MaxGain_x1024;
